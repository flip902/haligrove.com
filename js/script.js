...
$.getJSON(jsonURL, function (json) {
    ...
    $.each(json.images, function () {
      imgList += '<div class="col-lg-6 col-md-6 strainBox"><div class="thumbnail"><div class="strainImageDiv"><img src= "' + this.src + '"" alt="' + this.description + '" style="width:100%" id="' + this.id + '" onclick="modalWindow(' + this.id + ')"><div class="' + this.isNew + '">new</div><div class="' + this.sale + '"><a href ="/haligroveV2/content/specials.php">sale</a></div><div class="' + this.type + '">' + this.type + '</div></div>' +
